...
Click [here](https://github.com/Progress2002/hello-rails-back-end.git)
...
```sh
git clone https://github.com/Progress2002/hello-react-front-end.git
...
feel free to check the [issue page](https://github.com/Progress2002/hello-react-front-end/issues)
